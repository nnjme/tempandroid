 ...
 * 
 */
public class MyCardEdit implements OnClickListener {
	...
	public MyCardEdit(Context context) {
		this.mContext = context;
	}

	public MyCardEdit(Context context, List<Info> listData, int type, String pid) {
	...
	class SubmitTask extends AsyncTask<String, Integer, String> {
		...
		protected String doInBackground(String... params) {
			...
			String json = HttpUrlHelper.postData(map, "/people/imyEdit");
